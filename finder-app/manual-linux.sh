...
cd ${OUTDIR}/rootfs
mkdir -p bin dev etc home proc sbin sys tmp usr var
...
# Ensure conf directory exists and copy configs
mkdir -p ${OUTDIR}/rootfs/home/conf
cp conf/username.txt ${OUTDIR}/rootfs/home/conf/
cp conf/assignment.txt ${OUTDIR}/rootfs/home/conf/

# Change finder-test.sh to use correct conf path
...
echo "Build completed. Kernel Image and initramfs are in ${OUTDIR}"
