...
#include "aesd_ioctl.h"   /* Assignment 9: ioctl interface for AESDCHAR_IOCSEEKTO */
...
/* =============== Timestamp thread (used only if not char device) =============== */
#if !USE_AESD_CHAR_DEVICE
...
/* =============== Parse AESDCHAR_IOCSEEKTO:X,Y commands =============== */
